  ...
  methods: {
    ...
    applyCreateFormFieldDraft (draft) {
      ...
      if (draft.groupsEnable === false) {
        ...
        if (this.form.fd) this.form.fd[groupsField] = undefined
        this._groupsDraftApplying = false
        return
      }
      ...
      const writeGroups = () => {
        ...
        if (this.form.fd) this.form.fd[groupsField] = this.pendingGroups.slice()
        return true
      }
      this.$nextTick(() => {
        if (!writeGroups()) {
    ...
    writePendingGroups () {
      ...
      if (!this.filterPendingGroupsByList()) {
        if (this._groupsListLoaded) {
          ...
          if (this.form.fd) this.form.fd[groupsField] = []
        }
        return
      }
