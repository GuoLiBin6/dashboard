  ...
  data () {
    return {
        ...
        getTagTableColumn({ onManager: this.onManager, resource: 'cachedimage', columns: () => this.columns }),
        {
          ...
          formatter: ({ row }, h) => {
            ...
            return hFn('side-page-trigger', {
              props: { permission: 'domains_get', name: 'DomainSidePage', id: row.domain_id, vm: this },
            }, row.project_domain)
          },
        },
        {
          ...
          formatter: ({ row }, h) => {
            ...
            const hFn = h || this.$createElement
            return hFn('side-page-trigger', {
              props: { permission: 'projects_get', name: 'ProjectSidePage', id: row.tenant_id, vm: this },
            }, row.tenant)
          },
        },
      ...
      extraInfo: [
        ...
        //     default: ({ row }, h) => {
        //       return [
        //         <table-lite-grid class="mb-2" data={ this.imgSubformat } columns={ this.imageColumns } />,
        //       ]
        //     },
        //   },
        // },
