  ...
  <base-dialog @cancel="cancelDialog" :width="1000">
    ...
    <div slot="body">
      <a-alert class="mb-2" type="warning">
        <template #message>{{$t('compute.text_1167')}}</template>
      </a-alert>
      ...
      <a-form
        ...
        <a-form-item :label="$t('compute.isolated_device.category')">
          <a-radio-group v-model:value="deviceCategory" :disabled="deviceCategoryOptions.length <= 1" @change="onDeviceCategoryChange">
