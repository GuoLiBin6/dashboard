  ...
  methods: {
    ...
    async handleSubmit () {
      ...
      try {
        ...
        this.$message.success(this.$t('system.text_124', [this.$t('system.text_578')]))
      } catch (error) {
        this.$message.error(this.$t('common_622', [this.$t('system.text_578')]))
        throw error
      } finally {
