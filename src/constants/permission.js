...
export const PERMISSION = {
  ...
  container_registries_list: ['image', 'container_registries', 'list'],
  container_registries_get: ['image', 'container_registries', 'get'],
  container_registries_create: ['image', 'container_registries', 'create'],
  container_registries_update: ['image', 'container_registries', 'update'],
  container_registries_delete: ['image', 'container_registries', 'delete'],
  container_registries_perform_import_from_kubeserver: ['image', 'container_registries', 'perform', 'import-from-kubeserver'],
  container_images_list: ['image', 'container_images', 'list'],
  container_images_get: ['image', 'container_images', 'get'],
  container_images_create: ['image', 'container_images', 'create'],
  container_images_update: ['image', 'container_images', 'update'],
  container_images_delete: ['image', 'container_images', 'delete'],
  container_images_perform_public: ['image', 'container_images', 'perform', 'public'],
  container_images_perform_private: ['image', 'container_images', 'perform', 'private'],
  container_images_perform_change_owner: ['image', 'container_images', 'perform', 'change-owner'],
  // 硬盘
  ...
  server_perform_change_disk_driver: ['compute', 'servers', 'perform', 'change-disk-driver'],
  /**
   * images 相关操作
   */
  ...
  llm_skus_perform_clone: ['llm', 'llm_skus', 'perform', 'clone'],
  ...
  llm_deployments_list: ['llm', 'llm_deployments', 'list'],
  llm_deployments_get: ['llm', 'llm_deployments', 'get'],
  llm_deployments_create: ['llm', 'llm_deployments', 'create'],
  llm_deployments_update: ['llm', 'llm_deployments', 'update'],
  llm_deployments_delete: ['llm', 'llm_deployments', 'delete'],
  ...
  ai_providers_list: ['aiproxy', 'ai_providers', 'list'],
  ai_providers_get: ['aiproxy', 'ai_providers', 'get'],
  ai_providers_create: ['aiproxy', 'ai_providers', 'create'],
  ai_providers_update: ['aiproxy', 'ai_providers', 'update'],
  ...
  ai_providers_perform_set_models: ['aiproxy', 'ai_providers', 'perform', 'set-models'],

  ai_models_list: ['aiproxy', 'ai_models', 'list'],
  ai_models_get: ['aiproxy', 'ai_models', 'get'],
  ai_models_create: ['aiproxy', 'ai_models', 'create'],
  ai_models_update: ['aiproxy', 'ai_models', 'update'],
  ai_models_delete: ['aiproxy', 'ai_models', 'delete'],
  ai_models_perform_enable: ['aiproxy', 'ai_models', 'perform', 'enable'],
  ai_models_perform_disable: ['aiproxy', 'ai_models', 'perform', 'disable'],

  ai_keys_list: ['aiproxy', 'ai_keys', 'list'],
  ai_keys_get: ['aiproxy', 'ai_keys', 'get'],
  ai_keys_create: ['aiproxy', 'ai_keys', 'create'],
  ai_keys_update: ['aiproxy', 'ai_keys', 'update'],
  ai_keys_delete: ['aiproxy', 'ai_keys', 'delete'],
  ai_keys_perform_enable: ['aiproxy', 'ai_keys', 'perform', 'enable'],
  ai_keys_perform_disable: ['aiproxy', 'ai_keys', 'perform', 'disable'],

  ai_virtual_keys_list: ['aiproxy', 'ai_virtual_keys', 'list'],
  ai_virtual_keys_get: ['aiproxy', 'ai_virtual_keys', 'get'],
  ai_virtual_keys_create: ['aiproxy', 'ai_virtual_keys', 'create'],
  ai_virtual_keys_update: ['aiproxy', 'ai_virtual_keys', 'update'],
  ai_virtual_keys_delete: ['aiproxy', 'ai_virtual_keys', 'delete'],
  ai_virtual_keys_perform_enable: ['aiproxy', 'ai_virtual_keys', 'perform', 'enable'],
  ai_virtual_keys_perform_disable: ['aiproxy', 'ai_virtual_keys', 'perform', 'disable'],

  ai_routings_list: ['aiproxy', 'ai_routings', 'list'],
  ai_routings_get: ['aiproxy', 'ai_routings', 'get'],
  ai_routings_create: ['aiproxy', 'ai_routings', 'create'],
  ai_routings_update: ['aiproxy', 'ai_routings', 'update'],
  ai_routings_delete: ['aiproxy', 'ai_routings', 'delete'],
  ai_routings_perform_enable: ['aiproxy', 'ai_routings', 'perform', 'enable'],
  ai_routings_perform_disable: ['aiproxy', 'ai_routings', 'perform', 'disable'],
  ai_routings_perform_set_models: ['aiproxy', 'ai_routings', 'perform', 'set-models'],
  ai_routings_perform_public: ['aiproxy', 'ai_routings', 'perform', 'public'],
  ai_routings_perform_private: ['aiproxy', 'ai_routings', 'perform', 'private'],

  ai_routing_models_list: ['aiproxy', 'ai_routing_models', 'list'],
  ai_routing_models_get: ['aiproxy', 'ai_routing_models', 'get'],
  ai_routing_models_create: ['aiproxy', 'ai_routing_models', 'create'],
  ai_routing_models_update: ['aiproxy', 'ai_routing_models', 'update'],
  ai_routing_models_delete: ['aiproxy', 'ai_routing_models', 'delete'],

  ai_proxy_nodes_list: ['aiproxy', 'ai_proxy_nodes', 'list'],
  ai_proxy_nodes_get: ['aiproxy', 'ai_proxy_nodes', 'get'],
  ai_proxy_nodes_create: ['aiproxy', 'ai_proxy_nodes', 'create'],
  ai_proxy_nodes_update: ['aiproxy', 'ai_proxy_nodes', 'update'],
  ai_proxy_nodes_delete: ['aiproxy', 'ai_proxy_nodes', 'delete'],
  ai_proxy_nodes_perform_enable: ['aiproxy', 'ai_proxy_nodes', 'perform', 'enable'],
  ai_proxy_nodes_perform_disable: ['aiproxy', 'ai_proxy_nodes', 'perform', 'disable'],
